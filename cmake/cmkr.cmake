...
macro(cmkr)
    ...
    get_source_file_property(CMKR_CURRENT_LIST_FILE "cmkr.cmake" CMKR_CURRENT_LIST_FILE)
    if(CMKR_CURRENT_LIST_FILE)
        set(CMAKE_CURRENT_LIST_FILE "${CMKR_CURRENT_LIST_FILE}")
        get_filename_component(CMAKE_CURRENT_LIST_DIR "cmkr.cmake" DIRECTORY)
    endif()

    # File-based include guard (include_guard is not documented to work)
    get_source_file_property(CMKR_INCLUDE_GUARD "cmkr.cmake" CMKR_INCLUDE_GUARD)
    if(NOT CMKR_INCLUDE_GUARD)
        set_source_files_properties("cmkr.cmake" PROPERTIES CMKR_INCLUDE_GUARD TRUE)

        file(SHA256 "cmkr.cmake" CMKR_LIST_FILE_SHA256_PRE)
        ...
        file(SHA256 "cmkr.cmake" CMKR_LIST_FILE_SHA256_POST)
        ...
        if(NOT CMKR_LIST_FILE_SHA256_PRE STREQUAL CMKR_LIST_FILE_SHA256_POST)
            ...
            set_source_files_properties("${CMKR_TEMP_FILE}" PROPERTIES
                CMKR_CURRENT_LIST_FILE "cmkr.cmake"
            )
